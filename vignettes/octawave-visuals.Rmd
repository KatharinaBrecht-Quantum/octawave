---
title: "The Geometry of Resonance - With Figures"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{The Geometry of Resonance - With Figures}
...
```{r, echo=FALSE, out.width="65%", fig.align="center", fig.cap="Figure 1: Interactive 3D Quantum Field visualization showing the spatial symmetries and overlapping resonance zones of the octawave model."}
...
```{r, echo=FALSE, out.width="65%", fig.align="center", fig.cap="Figure 2: Tomographic Fullerene MRI Slice simulation at height z = -1.75, showing complex pentagonal interference patterns."}
